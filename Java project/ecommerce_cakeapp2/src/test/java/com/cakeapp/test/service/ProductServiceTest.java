...
public class ProductServiceTest {
	...
	public void testFindAllNotNull() {
		List<ProductData> list = new ArrayList<ProductData>();
		ProductData product1 = new ProductData(1L, "cake2", 400.0, "2Kg", "p1.jpg");
		ProductData product2 = new ProductData(2L, "cake3", 500.0, "2Kg", "p2.jpg");
		list.add(product1);
		list.add(product2);
	...
	public void testCreateNew() {
		...
		ProductData product3 = new ProductData(4L, "cake2", 400.0, "2Kg", "p1.jpg");
